...
void DAC5_Init(void){
    ...
    // Configure PB4-PB0 for GPIO function (0x00000081 is the standard Valvano mux setting)
    ...
    // Set direction of PB4-PB0 to output
...
void DAC5_Out(uint32_t data){
    // Friendly access: clear bits 4-0, then set them to the new 5-bit data value
    // The ~0x0000001F mask ensures bits 31-5 are untouched
    GPIOB->DOUT31_0 = (GPIOB->DOUT31_0 & ~0x0000001F) | (data & 0x0000001F);
}